...
import top.gumt.mall.member.dao.MemberDao;
...
import top.gumt.mall.member.service.MemberLevelService;
...
public class MemberServiceImpl extends ServiceImpl<MemberDao, MemberEntity> implements MemberService {
    ...
    @Override
    public void register(MemberRegisterVo registerVo) throws PhoneNumExistException, UserExistException  {
        //1 检查电话号是否唯一
    ...
    public MemberEntity login(SocialUser socialUser) {
        ...
        if(null == uid) {
            ...
            uid.setCity(location);
            uid.setHeader(profileImageUrl);
    ...
    // 检查是否有相同的用户名，有则抛处异常UserExistException
    ...
    // 检查是否有相同的手机号码，有则抛处PhoneNumExistException异常
