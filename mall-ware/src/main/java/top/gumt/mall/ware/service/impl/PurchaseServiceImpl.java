...
import top.gumt.common.constant.WareConstant;
import top.gumt.common.utils.PageUtils;
import top.gumt.common.utils.Query;

import top.gumt.mall.ware.dao.PurchaseDao;
...
import top.gumt.mall.ware.vo.PurchaseFinishItem;
...
public class PurchaseServiceImpl extends ServiceImpl<PurchaseDao, PurchaseEntity> implements PurchaseService {
    ...
    public void mergePurchase(MergeVo mergeVo) {
        ...
        if(purchaseId == null){
            ...
            //如果采购单的状态不是新建或已分配，则返回 (即确认采购状态为0,1)
    ...
    /**
     * 更新商品的采购状态，库存状态更为采购单的状态
     * （1）如果商品采购成功，则更新采购状态为已完成，更新库存值，更新采购单已经完成
     * （2）如果商品采购失败，则更新采购状态为采购失败， 更新采购单的状态为失败
    ...
    public void done(PurchaseFinishVo purchaseFinishVo) {
        //1. 改变采购项的状态
        List<PurchaseFinishItem> finishVoItems = purchaseFinishVo.getItems();
